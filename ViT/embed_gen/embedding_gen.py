...
# ======================
train_embeddings, train_labels = generate_embeddings(tile_encoder, train_loader, device)
torch.save(train_embeddings, "embeddings/train_tile_embeddings.pt")
torch.save(train_labels, "embeddings/train_tile_labels.pt")

val_embeddings, val_labels = generate_embeddings(tile_encoder, val_loader, device)
torch.save(val_embeddings, "embeddings/val_tile_embeddings.pt")
torch.save(val_labels, "embeddings/val_tile_labels.pt")

test_embeddings, test_labels = generate_embeddings(tile_encoder, test_loader, device)
torch.save(test_embeddings, "embeddings/test_tile_embeddings.pt")
torch.save(test_labels, "embeddings/test_tile_labels.pt")
